...
export class AuthService {
  ...
  constructor(
    ...
    this.loginStatus = new BehaviorSubject<any>(
      this.store.getItem("loginStatus")
    );
    this.currentUser = new BehaviorSubject<any>(
      this.store.getItem("currentUser")
    );
  }
  ...
  signin(credentials): Observable<any> {
    ...
    return this.http
      .post<any>(`${environment.apiUrl}/login.php`, credentials, httpOptions)
      .pipe(
        map((user) => {
  ...
  signup(signup): Observable<any> {
    ...
    return this.http
      .post<any>(`${environment.apiUrl}/register`, null, httpOptions)
      .pipe(
        map((user) => {
  ...
  forgotPasswordByPhone(forgotByPhone): Observable<any> {
    return this.http.post<any>(
      `${environment.apiUrl}/account/forgot-password-phone`,
      forgotByPhone
    );
  }
  getPhoneEmailUserNameApi(PhoneEmailUserName: any): Observable<any> {
    return this.http
      .get<any>(
        `${environment.apiUrl}/account/forgot-password?name=${PhoneEmailUserName}`
      )
      .pipe(
        map((res) => {
          return res;
  ...
  resetPasswordByPhone(resetByPhone): Observable<any> {
    ...
    return this.http.put<any>(
      `${environment.apiUrl}/account/reset-password-phone`,
      resetByPhone
    );
  }
  forgotPasswordByEmail(forgotByEmail): Observable<any> {
    return this.http.post<any>(
      `${environment.apiUrl}/account/forgot-password-email`,
      forgotByEmail
    );
  }
  resetPasswordByEmail(resetByEmail): Observable<any> {
    return this.http.put<any>(
      `${environment.apiUrl}/account/reset-password-email`,
      resetByEmail
    );
  }
